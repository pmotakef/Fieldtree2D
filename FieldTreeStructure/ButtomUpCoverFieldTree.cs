...
using FieldTreeStructure.FieldTree;

namespace FieldTreeStructure
{
    public class ButtomUpCoverFieldTree<T> where T : ISpatial, new()
    {
        private ButtomUpCoverFieldTreeStructure<T> fieldTree;
        //private Size size;
        private double pVal;
        ...
        /// <summary>
        /// Sets up the Cover Field Tree Data Structure
        /// </summary>
        /// <param name="width">Total width of data extent.</param>
        /// <param name="height">Total height of data extent.</param>
        /// <param name="p_value">p-value in Cover Field Tree is used to enlarge each node by (1 + p) for higher efficiency in storage. 0 < p < 1.</param>
        ...
        public ButtomUpCoverFieldTree(double p_value, int capacity = 2)
        {
        ...
        /// <summary>
        /// Creates a new Cover Field Tree and dumps the old one.
        /// </summary>
        public void Clear()
        {
            fieldTree = new ButtomUpCoverFieldTreeStructure<T>(Capacity, pVal);
        }
        ...
        public List<T> All()
        {
            Rectangle extents = fieldTree.GetTreeExtents();
            return RangeQuery(extents.Center.X, extents.Center.Y, extents.Width, extents.Height);
        }
