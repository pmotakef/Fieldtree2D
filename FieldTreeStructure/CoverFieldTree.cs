...
namespace FieldTreeStructure
{
    public class CoverFieldTree<T> where T : ISpatial, new()
    {
        ...
        public CoverFieldTree(int width, int height, double p_value, int centerX = 0, int centerY = 0, int capacity = 2)
        {
        ...
        public void Clear()
        {
            fieldTree = new CoverFieldTreeStructure<T>(new Rectangle(Center, size), Capacity, pVal);
        }
