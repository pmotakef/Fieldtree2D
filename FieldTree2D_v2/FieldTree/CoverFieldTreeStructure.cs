...
using FieldTree2D_v2.Node.Cover;
using FieldTree2D_v2.Geometry;
using Priority_Queue;

namespace FieldTree2D_v2.FieldTree
{
    public class CoverFieldTreeStructure<T> where T : ISpatial
    {
        /// <summary>
